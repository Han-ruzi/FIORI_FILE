		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RUAT",
									"targetURL": "#ANSypratice04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ANSypratice04-display": {
								"semanticObject": "ANSypratice04",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ANS.ypratice04",
									"url": sap.ui.require.toUrl("ANS/ypratice04")
								}
							}
						}
					}
