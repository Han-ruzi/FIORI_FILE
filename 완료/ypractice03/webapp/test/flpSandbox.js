		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsmilegateypratice03-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmilegateypratice03-display": {
								"semanticObject": "comsmilegateypratice03",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smilegate.ypratice03",
									"url": sap.ui.require.toUrl("com/smilegate/ypratice03")
								}
							}
						}
					}
