		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Monthly Settlement Activity Calendar",
									"targetURL": "#comsmilegatezappfi004-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmilegatezappfi004-display": {
								"semanticObject": "comsmilegatezappfi004",
								"action": "display",
								"description": "Monthly Settlement Activity Calendar - Personal",
								"title": "Monthly Settlement Activity Calendar",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smilegate.zappfi004",
									"url": sap.ui.require.toUrl("com/smilegate/zappfi004")
								}
							}
						}
					}
