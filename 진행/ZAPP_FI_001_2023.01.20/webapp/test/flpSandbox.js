		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Monthly Settlement Activity List",
									"targetURL": "#comsmilegatezappfi001-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmilegatezappfi001-display": {
								"semanticObject": "comsmilegatezappfi001",
								"action": "display",
								"description": "Monthly Settlement Activity List - Personal",
								"title": "Monthly Settlement Activity List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smilegate.zappfi001",
									"url": sap.ui.require.toUrl("com/smilegate/zappfi001")
								}
							}
						}
					}
